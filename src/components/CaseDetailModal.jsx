    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          {loading && <div className="ai-loading"><div className="spinner" /><span>Groq is analyzing...</span></div>}
          {aiResult && <div className="ai-result"><h4><i className="fas fa-robot" /> Groq AI Analysis</h4><div className="ai-md" dangerouslySetInnerHTML={{ __html: renderMd(aiResult) }} /></div>}
        </div>
